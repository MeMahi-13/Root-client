const Suite = () => (
  <section className="py-16 bg-white dark:bg-gray-900 transition-colors duration-500">
    <div className="max-w-7xl mx-auto px-6 space-y-12">
      ...
      {/* Title & Intro */}
      <h2 className="text-5xl text-center text-gray-900 dark:text-white">Structure and Shelter</h2>
      <p className="text-center px-4 sm:px-16 text-gray-700 dark:text-gray-300">
      ...
      <div className="space-y-8">
        <div className="flex flex-col space-y-2 px-4 md:px-0">
          <h3 className="text-4xl font-semibold text-gray-900 dark:text-white">The Sky View</h3>
          <p className="text-xl text-gray-600 dark:text-gray-400">So close to the sky</p>
        </div>
      ...
      <div>
        <div className="flex flex-col space-y-2 px-4 md:px-0 pt-12 items-end">
          ...
          <p className="text-xl text-gray-600 dark:text-gray-400">
            embark on a journey into yourself, to your origins, to the essentials
          </p>
        </div>
